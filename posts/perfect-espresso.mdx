...
Preheat your coffee machine have two benefits. The first one is to eject water that was stuck and not really hot pipes. The second one is to heat the pipes to keep more longer the good temperature. The standard water temperature is around 93ºC - 199ºF. 

### 5. Prepare the Portafilter:

Fore a good shot, some conditions has to be done before tamp the coffee. The first one is if you have some coffee blocks, you need to breaks them to only have fine grind.
<br/>The second step is to distribute evenly because if you tamp your coffee and there is more in one side, the water will go in the simplest side.
<br/>that is why your the distribution of your coffee must be equal. There is tool to help you to do it like a WDT tool to break the blocks or a coffee distributor….

### 6. Tamp the Coffee:

Tamp a coffee is a precise a more muscular movement. Likely to not be complicated, some tamper have a spring to always tamp as the same pressure because tamp to much is not good and not tamp enough is not good either because of the water will pass through too fast or not passe at all.
<br/>it’s more complicated to tamp too much counter to not tamp enough. The good tamp is like 10-13kg / 15-30lbs.<br/>The most important in this part is to be horizontal. The same as before, if the we tamp more in one side, the water will go through the most simple way. 
Try to hold the portafilter horizontally and tamp as the same. If it’s a simple tamper, try to guide you with your finger to see if your tamping to much in one side or not.
<br/>It’s all good, Insert your portafilter securely.

### 8. Start the Extraction:

The extraction is like a recipe, if you have 18g of coffee, the most used recipe is 40g of coffee at the end for 25-30sec of extraction.
<br/>The time start a the first drop of coffee touch the cup. Too help you in all tasks, you must have a precise scale.
If the coffee is going to fast, it’s most of the time the grind. Too coarse. if Is too slow instead it’s too fine.
<br/>It can be also the tamp but try to tamp as the same pressure and keep it. Thing that need to change is the grind of coffee.
